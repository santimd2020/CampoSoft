...
class Informacion:
    ...
    def estado(self):
        try:
            conexion = psycopg2.connect(database="persona", user="postgres", password="12345678",host="campsoft.cubqdb8xhzud.us-east-1.rds.amazonaws.com", port="5432", connect_timeout=29)
